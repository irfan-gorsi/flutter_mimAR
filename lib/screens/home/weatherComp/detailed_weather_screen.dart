...
class DetailedWeatherScreen extends StatelessWidget {
  ...
  Widget buildInfoRow(IconData icon, String label, String value) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, color: Colors.black),  // changed from blue.shade700 to black
                  ...
                  children: [
                    Text(
                      ...
                      style: const TextStyle(
                        ...
                        color: Colors.black,  // changed from blueAccent to black
                      ),
                    ),
                    const SizedBox(height: 8),
                    Image.network(
                      'http://openweathermap.org/img/wn/${weather['icon'] ?? '01d'}@4x.png',
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      'Temperature',
                      style: TextStyle(
                          fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black),  // changed here
                    ),
